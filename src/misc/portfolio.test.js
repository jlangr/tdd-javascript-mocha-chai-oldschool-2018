...
// const { createPortfolio, empty, purchase, sharesOf, size, value } = require('./portfolio')
...
describe('a portfolio', () => {
  ...
  describe('portfolio value with stub', () => {
    ...
    it('is symbol price for single-share purchase', () => {
      ...
      // TODO real 'ctor' in oldschool JS
      portfolioData = portfolioObj.createPortfolio()
